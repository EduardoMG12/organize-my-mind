...
describe("AnnotationService", () => {
    ...
    it('should create an annotation', async () => {
        ...
        jest.spyOn(repository, 'create').mockReturnValue(createdAnnotation as Annotation);
        ...
        expect(repository.create).toHaveBeenCalledWith({ user, ...annotationData, position: 0 });
    ...
    it('should update the order of annotations', async () => {
        ...
        jest.spyOn(repository, 'save').mockImplementation(async (data) => data as any);
    ...
    it('should update an annotation', async () => {
        ...
        jest.spyOn(repository, 'save').mockImplementation(async (data) => data as Annotation);
